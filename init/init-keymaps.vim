...
noremap <m-u> Tools_PreviousCursor(2)
noremap <m-d> Tools_PreviousCursor(3)
...
if 0
    ...
    " 更新 cmake
    nAsyncRun -cwd=nAsyncRun -cwd=oAsyncRun -cwd=remap <silent> <F4> :AsyncRun -cwd=<root> cmake . <cr>
